...
class Screen:
	...
	def write_char(self, cursor, ch, rendition):
		self.cells[cursor.y][cursor.x] = ch	
		self.gfx[cursor.y][cursor.x] = rendition | GFX_WRITTEN

	def erase_rectangle(self, top_row, left_col, bot_row, right_col, rendition=0): # XXX: need to pass in active rendition
